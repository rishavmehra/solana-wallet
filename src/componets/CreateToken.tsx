...
//         // Initialize metadataPointer for the mint
//         createInitializeGroupPointerInstruction(
//             mintKeypair.publicKey,
//             wallet.publicKey,
//             mintKeypair.publicKey,
...
//         transaction.partialSign(mintKeypair) // more research 

//         await wallet.sendTransaction(transaction, connection)

//         setStatus(
//             `token mint created at ${mintKeypair.publicKey.toBase58()} with token at ${associatedToken.toBase58}`
//         )
//         setName("")
//         setDecimals("")
//         setImageUrl("")
//         setInitialSupply("")
//         setSymbol("")
//     //   await sendAndConfirmTransaction(connection, transaction, [mintKeypair]);
...
//         className={`w-full py-3 px-4 bg-indigo-600 text-white rounded-md hover:bg-indigo-500 transition-colors duration-300 ${
...
const CreateToken = () => {
  ...
  const handleCreateToken = async () => {
    ...
    try {
      ...
      setStatus(
        `Token mint created at ${mintKeypair.publicKey.toBase58()} with associated token account at ${associatedToken.toBase58()}`
      );
      setName("");
      setDecimals("");
      setImageUrl("");
